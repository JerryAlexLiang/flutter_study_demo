...
wanAndroidArticleBeanEntityFromJson(WanAndroidArticleBeanEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = new WanAndroidArticleBeanData().fromJson(json['data']);
	}
...
wanAndroidArticleBeanDataFromJson(WanAndroidArticleBeanData data, Map<String, dynamic> json) {
	...
	if (json['datas'] != null) {
		data.datas = new List<WanAndroidArticleBeanDataData>();
		(json['datas'] as List).forEach((v) {
			data.datas.add(new WanAndroidArticleBeanDataData().fromJson(v));
		});
	}
	if (json['offset'] != null) {
